...
public class ExperimentController implements Controller {
    ...
    private Queue<ExperimentMessage> experimentMessagesQueue = new ConcurrentLinkedQueue<ExperimentMessage>();
     ...
     *
     * @throws ExperimentationException, Generic exception related with exceptions found
