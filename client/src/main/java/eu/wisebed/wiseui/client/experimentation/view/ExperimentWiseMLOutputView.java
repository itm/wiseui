...
@ImplementedBy(ExperimentWiseMLOutputViewImpl.class)
public interface ExperimentWiseMLOutputView extends IsWidget {

	void show(String title);
	
	void hide();
	
	void addWiseMLOutput(String wiseMlString);
